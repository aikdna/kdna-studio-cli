...
function cmdExport(args) {
  ...
  const finalDigest = compileApi.computeContentDigest(files); console.error("EXPORT_DIGEST:" + finalDigest); console.error("EXPORT_FILE_KEYS:" + JSON.stringify(Object.keys(files).sort())); console.error("EXPORT_READMEMD_LEN:" + (files["README.md"]||"").length);
